...
\begin{exercice}
  ...
  \begin{sol}
    ...
    calculer $\sqrt[3]{21}$ par la méthode du point fixe. La \autoref{fig:resolution:racinecubique} présente ces trois fonctions.
    \begin{figure}
      \centering
...
\begin{exercice}
  ...
  \begin{sol}
    ...
    donc la convergence sera lente; voir la \autoref{fig:resolution:a_angle:g2}. Enfin, on peut considérer la fonction
    \begin{align*}
      g_3(i)
...
\begin{exercice}
  ...
  l'\autoref{exercice:avance:pareto} de la partie~I.
