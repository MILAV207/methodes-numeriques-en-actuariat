\documentclass[letterpaper,11pt]{memoir}
  ...
  \title{\HUGE
    ...
    \huge
    \fontseries{m}\selectfont Partie I \\
    \fontseries{m}\selectfont Programmation en R}
...
%  \includeonly{avant-partie_1,introduction-partie_1,arriere-partie_1}
...
\pagestyle{empty}
\include{avant-partie_1}        % différent de Introduction à la...

\pagestyle{companion}

\include{introduction-partie_1} % différent de Introduction à la...
\cleartorecto
\tableofcontents*
...
\include{emacs+ess}
\include{packages}
\include{reponses-partie_1}     % différent de Introduction à la...
...
\include{arriere-partie_1}        % différent de Introduction à la...
