\documentclass[letterpaper,11pt,x11names,english,french]{memoir}
  ...
  \definecolor{prob}{named}{orange}              % boîtes «problème»
  ...
  %% lorsque la boîte se poursuit après un saut de page.
  ...
  %% Boîte générique avec titre basée sur titled-frame, ci-dessus.
  %% Sert pour les listes d'objectifs et les boîtes reliées aux
  %% problèmes (mises en situation) dans les chapitres.
  ...
  \newenvironment{prob-enonce}{%
    \begin{emphbox}[prob]{Énoncé du problème}}%
    {\end{emphbox}}
  \newenvironment{prob-astuce}{%
    \begin{emphbox}[prob]{Astuce}}%
    {\end{emphbox}}
  \newenvironment{prob-solution}{%
    \begin{emphbox}[prob]{Solution du problème}}%
    {\end{emphbox}}
