\documentclass[letterpaper,11pt]{memoir}
  ...
  \hypersetup{colorlinks,allcolors=link,
    pdftitle={Méthodes numériques en actuariat - Partie I Introduction
  ...
  \newenvironment{exercice}{%
    \begin{list}{}{%
        ...
        \Writetofile{reponses}{\protect\hypertarget{rep:\theexercice}{}}
        \renewcommand{\makelabel}{%
          \bfseries\protect\hyperlink{rep:\theexercice}{\theexercice}}
